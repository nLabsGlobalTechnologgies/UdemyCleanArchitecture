...
using System.Text;
using UdemyCleanArchitecture.Application.Abstractions;
using UdemyCleanArchitecture.Domain.Entities;

namespace UdemyCleanArchitecture.Infrastructure.Authentication;
public sealed class JwtProvider : IJwtProvider
{
    private readonly JwtOptions _jwtOptions;
    private readonly UserManager<AppUser> _userManager;
    public JwtProvider(JwtOptions jwtOptions, UserManager<AppUser> userManager)
    {
